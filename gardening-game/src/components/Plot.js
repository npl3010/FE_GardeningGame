...
function Plot({ position, bag, toolsInUse, removeLastItemFromBag, harvestAndSellPlant, showMessageBox,
    ...
    return (
        <div className="plot">
            <Plant position={(position * 6) + 0} bag={bag} toolsInUse={toolsInUse} removeLastItemFromBag={removeLastItemFromBag} harvestAndSellPlant={harvestAndSellPlant} seedName={seedName} numerOfPlants={numerOfPlants} setPlantName={setPlantName} addOrRemovePlant={addOrRemovePlant} showMessageBox={showMessageBox} sound_glimmer={sound_glimmer} sound_zigzag={sound_zigzag} sound_flash={sound_flash} setNumberOfPestsKilled={setNumberOfPestsKilled}></Plant>
